...
<div class="full-width-split group">
  <div class="full-width-split__one">
    <div class="full-width-split__inner">
      ...
      // Pull up 2 upcoming events from today
      $today = date('Ymd');
  ...
  <div class="full-width-split__two">
    <div class="full-width-split__inner">
      ...
      <!-- Pull up two most recent blogposts -->
      <?php
      $args = array(
        'posts_per_page' => 2,
      );
      ...
      <p class="t-center no-margin"><a href="<?php echo site_url('/blogs') ?>" class="btn btn--yellow">View All Blog
          Posts</a></p>
    </div>
  </div>
</div>
